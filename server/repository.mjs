...
export class MySqlWardrobeRepository {
  ...
  async loadImported() {
    // NOTE: subcategory/brand and the "thumbnail" asset kind need migrations/003_wardrobe_item_details.sql
    // applied first (adds the columns / extends the asset_kind enum) — until that migration has run
    // against this database, referencing them here would throw "Unknown column"/enum-violation errors
    // instead of degrading gracefully, taking down the whole wardrobe list. Re-enable once migrated.
